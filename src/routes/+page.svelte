...
<div class="content">
  ...
  <div id="yugiohCardCarousel" class="carousel slide" data-bs-ride="carousel">
    ...
    <!-- Controls -->
    <button class="carousel-control-prev" type="button" data-bs-target="#yugiohCardCarousel" data-bs-slide="prev">
      <span class="carousel-control-prev-icon" aria-hidden="true"></span>
      <span class="visually-hidden">Previous</span>
    </button>
    <button class="carousel-control-next" type="button" data-bs-target="#yugiohCardCarousel" data-bs-slide="next">
  ...
  <div class="cta-section">
    ...
    <div class="footer-note">
      <p>Besuche <a href="https://www.db.yugioh-card.com/yugiohdb/?request_locale=en" target="_blank" rel="noopener noreferrer">Yugioh Neuron</a> für weitere offizielle Informationen zu Yu-Gi-Oh!</p>
    </div>
  </div>
</div>
